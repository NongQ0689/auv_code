...
class TrackingSystem:
    def __init__(self, width, height, serial_port=None, baud_rate=115200, show_frame=True, detect_tag=False, save_video=False):
        ...
        base_path = "/home/q/auv_code/"
        model_path = os.path.join(base_path, "frozen_inference_graph.pb")
        config_path = os.path.join(base_path, "ssd_mobilenet_v2_coco.pbtxt")
        ...
        if self.net.empty():
            raise ValueError("Failed to load MobileNet SSD model. Check file integrity or compatibility.")

        # รายการคลาสจาก COCO dataset
    ...
    def detect_human(self, frame):
        """ ตรวจจับมนุษย์และคำนวณตำแหน่งด้วย MobileNet SSD """
